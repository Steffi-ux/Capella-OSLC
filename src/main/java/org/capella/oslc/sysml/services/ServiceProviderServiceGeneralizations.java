...
public class ServiceProviderServiceGeneralizations
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderServiceGeneralizations.class);
    ...
    public ServiceProviderServiceGeneralizations()
    {
        super();
    }
                                    ...
                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/generalizationscollection.jsp");
