...
public class ServiceProviderServiceSysmlPackages
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderServiceSysmlPackages.class);
    ...
    public ServiceProviderServiceSysmlPackages()
    {
        super();
    }
