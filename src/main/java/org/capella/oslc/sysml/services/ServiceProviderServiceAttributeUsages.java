...
@Path("projects/{projectId}/service10/attributeUsages")
@Api(value = "OSLC Service for {" + SysmlDomainConstants.ATTRIBUTEUSAGE_LOCALNAME + "}")
public class ServiceProviderServiceAttributeUsages
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderServiceAttributeUsages.class);
    ...
    public ServiceProviderServiceAttributeUsages()
    {
        super();
    }
    ...
    (
        ...
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + SysmlDomainConstants.ATTRIBUTEUSAGE_PATH,
        resourceTypes = {SysmlDomainConstants.ATTRIBUTEUSAGE_TYPE},
        usages = {}
    )
    @GET
    @Path("query")
    ...
    @ApiOperation(
        value = "Query capability for resources of type {" + SysmlDomainConstants.ATTRIBUTEUSAGE_LOCALNAME + "}",
        notes = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.ATTRIBUTEUSAGE_TYPE + "\">" + SysmlDomainConstants.ATTRIBUTEUSAGE_LOCALNAME + "</a>" + "}" +
    ...
    public AttributeUsage[] queryAttributeUsages(
                                                    ...
                                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        final List<AttributeUsage> resources = SysmlServerManager.queryAttributeUsages(httpServletRequest, projectId, where, prefix, page, pageSize);
        ...
        return resources.toArray(new AttributeUsage [resources.size()]);
    }
    ...
    public void queryAttributeUsagesAsHtml(
                                    @PathParam("projectId") final String projectId ,
                                       @QueryParam("oslc.where") final String where,
                                       @QueryParam("oslc.prefix") final String prefix,
                                       @QueryParam("page") final String pageString,
                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        // Start of user code queryAttributeUsagesAsHtml
        // End of user code
        ...
        if (resources!= null) {
            ...
            // Start of user code queryAttributeUsagesAsHtml_setAttributes
            // End of user code
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/attributeusagescollection.jsp");
    ...
    (
         ...
         uri = "projects/{projectId}/service10/attributeUsages/selector",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {SysmlDomainConstants.ATTRIBUTEUSAGE_TYPE},
         usages = {}
    ...
    public void AttributeUsageSelector(
        @QueryParam("terms") final String terms
        , @PathParam("projectId") final String projectId
        ) throws ServletException, IOException
    {
        // Start of user code AttributeUsageSelector_init
        // End of user code
        ...
        // Start of user code AttributeUsageSelector_setAttributes
        // End of user code

        if (terms != null ) {
            httpServletRequest.setAttribute("terms", terms);
            final List<AttributeUsage> resources = SysmlServerManager.AttributeUsageSelector(httpServletRequest, projectId, terms);
            if (resources!= null) {
                        httpServletRequest.setAttribute("resources", resources);
                        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/attributeusageselectorresults.jsp");
                        rd.forward(httpServletRequest, httpServletResponse);
                        return;
            }
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/attributeusageselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        }
    }
