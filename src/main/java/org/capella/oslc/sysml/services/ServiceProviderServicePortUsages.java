...
@Path("projects/{projectId}/service9/portUsages")
@Api(value = "OSLC Service for {" + SysmlDomainConstants.PORTUSAGE_LOCALNAME + "}")
public class ServiceProviderServicePortUsages
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderServicePortUsages.class);
    ...
    public ServiceProviderServicePortUsages()
    {
        super();
    }
    ...
    (
        ...
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + SysmlDomainConstants.PORTUSAGE_PATH,
        resourceTypes = {SysmlDomainConstants.PORTUSAGE_TYPE},
        usages = {}
    )
    @GET
    @Path("query")
    ...
    @ApiOperation(
        value = "Query capability for resources of type {" + SysmlDomainConstants.PORTUSAGE_LOCALNAME + "}",
        notes = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.PORTUSAGE_TYPE + "\">" + SysmlDomainConstants.PORTUSAGE_LOCALNAME + "</a>" + "}" +
    ...
    public PortUsage[] queryPortUsages(
                                                    ...
                                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        final List<PortUsage> resources = SysmlServerManager.queryPortUsages(httpServletRequest, projectId, where, prefix, page, pageSize);
        ...
        return resources.toArray(new PortUsage [resources.size()]);
    }
    ...
    public void queryPortUsagesAsHtml(
                                    @PathParam("projectId") final String projectId ,
                                       @QueryParam("oslc.where") final String where,
                                       @QueryParam("oslc.prefix") final String prefix,
                                       @QueryParam("page") final String pageString,
                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        // Start of user code queryPortUsagesAsHtml
        // End of user code
        ...
        if (resources!= null) {
            ...
            // Start of user code queryPortUsagesAsHtml_setAttributes
            // End of user code
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/portusagescollection.jsp");
    ...
    (
         ...
         uri = "projects/{projectId}/service9/portUsages/selector",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {SysmlDomainConstants.PORTUSAGE_TYPE},
         usages = {}
    ...
    public void PortUsageSelector(
        @QueryParam("terms") final String terms
        , @PathParam("projectId") final String projectId
        ) throws ServletException, IOException
    {
        // Start of user code PortUsageSelector_init
        // End of user code
        ...
        // Start of user code PortUsageSelector_setAttributes
        // End of user code

        if (terms != null ) {
            httpServletRequest.setAttribute("terms", terms);
            final List<PortUsage> resources = SysmlServerManager.PortUsageSelector(httpServletRequest, projectId, terms);
            if (resources!= null) {
                        httpServletRequest.setAttribute("resources", resources);
                        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/portusageselectorresults.jsp");
                        rd.forward(httpServletRequest, httpServletResponse);
                        return;
            }
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/portusageselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        }
    }
