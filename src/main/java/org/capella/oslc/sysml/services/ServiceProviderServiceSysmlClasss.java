...
public class ServiceProviderServiceSysmlClasss
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderServiceSysmlClasss.class);
    ...
    public ServiceProviderServiceSysmlClasss()
    {
        super();
    }
                                    ...
                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/sysmlclassscollection.jsp");
...
//        // End of user code
        ...
        if (terms != null ) {
            ...
            if (resources!= null) {
                        httpServletRequest.setAttribute("resources", resources);
                        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/sysmlclassselectorresults.jsp");
                        rd.forward(httpServletRequest, httpServletResponse);
                        return;
            }
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/sysmlclassselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        }
    }
