...
public class ServiceProviderServicePartUsages
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderServicePartUsages.class);
    ...
    public ServiceProviderServicePartUsages()
    {
        super();
    }
                                    ...
                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/partusagescollection.jsp");
        ...
        ) throws ServletException, IOException
    {
        ...
        if (terms != null ) {
            ...
            if (resources!= null) {
                        httpServletRequest.setAttribute("resources", resources);
                        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/partusageselectorresults.jsp");
                        rd.forward(httpServletRequest, httpServletResponse);
                        return;
            }
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/partusageselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        }
    }
