...
public class ServiceProviderServiceElements
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderServiceElements.class);
    ...
    public ServiceProviderServiceElements()
    {
        super();
    }
    ...
    @ApiOperation(
        value = "Query capability for resources of type {" + SysmlDomainConstants.ELEMENT_LOCALNAME + "}",
        notes = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.ELEMENT_TYPE + "\">" + SysmlDomainConstants.ELEMENT_LOCALNAME + "</a>" + "}" +
                                    ...
                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/elementscollection.jsp");
        ...
        ) throws ServletException, IOException
    {
        ...
        if (terms != null ) {
            ...
            if (resources!= null) {
                        httpServletRequest.setAttribute("resources", resources);
                        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/elementselectorresults.jsp");
                        rd.forward(httpServletRequest, httpServletResponse);
                        return;
            }
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/elementselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        }
    }
