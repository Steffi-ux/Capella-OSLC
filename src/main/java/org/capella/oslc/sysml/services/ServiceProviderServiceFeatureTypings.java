...
@Path("projects/{projectId}/service8/featureTypings")
@Api(value = "OSLC Service for {" + SysmlDomainConstants.FEATURETYPING_LOCALNAME + "}")
public class ServiceProviderServiceFeatureTypings
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderServiceFeatureTypings.class);
    ...
    public ServiceProviderServiceFeatureTypings()
    {
        super();
    }
    ...
    (
        ...
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + SysmlDomainConstants.FEATURETYPING_PATH,
        resourceTypes = {SysmlDomainConstants.FEATURETYPING_TYPE},
        usages = {}
    )
    @GET
    @Path("query")
    ...
    @ApiOperation(
        value = "Query capability for resources of type {" + SysmlDomainConstants.FEATURETYPING_LOCALNAME + "}",
        notes = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.FEATURETYPING_TYPE + "\">" + SysmlDomainConstants.FEATURETYPING_LOCALNAME + "</a>" + "}" +
    ...
    public FeatureTyping[] queryFeatureTypings(
                                                    ...
                                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        final List<FeatureTyping> resources = SysmlServerManager.queryFeatureTypings(httpServletRequest, projectId, where, prefix, page, pageSize);
        ...
        return resources.toArray(new FeatureTyping [resources.size()]);
    }
    ...
    public void queryFeatureTypingsAsHtml(
                                    @PathParam("projectId") final String projectId ,
                                       @QueryParam("oslc.where") final String where,
                                       @QueryParam("oslc.prefix") final String prefix,
                                       @QueryParam("page") final String pageString,
                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        // Start of user code queryFeatureTypingsAsHtml
        // End of user code
        ...
        if (resources!= null) {
            ...
            // Start of user code queryFeatureTypingsAsHtml_setAttributes
            // End of user code
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/featuretypingscollection.jsp");
    ...
    (
         ...
         uri = "projects/{projectId}/service8/featureTypings/selector",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {SysmlDomainConstants.FEATURETYPING_TYPE},
         usages = {}
    ...
    public void FeatureTypingSelector(
        @QueryParam("terms") final String terms
        , @PathParam("projectId") final String projectId
        ) throws ServletException, IOException
    {
        // Start of user code FeatureTypingSelector_init
        // End of user code
        ...
        // Start of user code FeatureTypingSelector_setAttributes
        // End of user code

        if (terms != null ) {
            httpServletRequest.setAttribute("terms", terms);
            final List<FeatureTyping> resources = SysmlServerManager.FeatureTypingSelector(httpServletRequest, projectId, terms);
            if (resources!= null) {
                        httpServletRequest.setAttribute("resources", resources);
                        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/featuretypingselectorresults.jsp");
                        rd.forward(httpServletRequest, httpServletResponse);
                        return;
            }
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/featuretypingselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        }
    }
