...
public class ServiceProviderServiceRelationships
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderServiceRelationships.class);
    ...
    public ServiceProviderServiceRelationships()
    {
        super();
    }
    ...
    (
        ...
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + SysmlDomainConstants.RELATIONSHIP_PATH,
    ...
    @ApiOperation(
        value = "Query capability for resources of type {" + SysmlDomainConstants.RELATIONSHIP_LOCALNAME + "}",
        notes = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.RELATIONSHIP_TYPE + "\">" + SysmlDomainConstants.RELATIONSHIP_LOCALNAME + "</a>" + "}" +
                                                    ...
                                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        return resources.toArray(new Relationship [resources.size()]);
    }
                                    ...
                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            // Start of user code queryRelationshipsAsHtml_setAttributes
            // End of user code
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/relationshipscollection.jsp");
...
//        // End of user code
        ...
        // Start of user code RelationshipSelector_setAttributes
//        // End of user code
        ...
        if (terms != null ) {
            ...
            if (resources!= null) {
                        httpServletRequest.setAttribute("resources", resources);
                        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/relationshipselectorresults.jsp");
                        rd.forward(httpServletRequest, httpServletResponse);
                        return;
            }
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/relationshipselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        }
    }
