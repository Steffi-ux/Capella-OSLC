...
@Path("projects/{projectId}/service13/connectors")
@Api(value = "OSLC Service for {" + SysmlDomainConstants.CONNECTOR_LOCALNAME + "}")
public class ServiceProviderServiceConnectors
{
    @Context private HttpServletRequest httpServletRequest;
    @Context private HttpServletResponse httpServletResponse;
    @Context private UriInfo uriInfo;

    private static final Logger log = LoggerFactory.getLogger(ServiceProviderServiceConnectors.class);
    ...
    public ServiceProviderServiceConnectors()
    {
        super();
    }
    ...
    (
        ...
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + SysmlDomainConstants.CONNECTOR_PATH,
        resourceTypes = {SysmlDomainConstants.CONNECTOR_TYPE},
        usages = {}
    )
    @GET
    @Path("query")
    ...
    @ApiOperation(
        value = "Query capability for resources of type {" + SysmlDomainConstants.CONNECTOR_LOCALNAME + "}",
        notes = "Query capability for resources of type {" + "<a href=\"" + SysmlDomainConstants.CONNECTOR_TYPE + "\">" + SysmlDomainConstants.CONNECTOR_LOCALNAME + "</a>" + "}" +
            ", with respective resource shapes {" + "<a href=\"" + "../services/" + OslcConstants.PATH_RESOURCE_SHAPES + "/" + SysmlDomainConstants.CONNECTOR_PATH + "\">" + SysmlDomainConstants.CONNECTOR_LOCALNAME + "</a>" + "}",
    ...
    public Connector[] queryConnectors(
                                                    ...
                                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws IOException, ServletException
    {
        ...
        final List<Connector> resources = SysmlServerManager.queryConnectors(httpServletRequest, projectId, where, prefix, page, pageSize);
        ...
        return resources.toArray(new Connector [resources.size()]);
    }
    ...
    public void queryConnectorsAsHtml(
                                    @PathParam("projectId") final String projectId ,
                                       @QueryParam("oslc.where") final String where,
                                       @QueryParam("oslc.prefix") final String prefix,
                                       @QueryParam("page") final String pageString,
                                    @QueryParam("oslc.pageSize") final String pageSizeString) throws ServletException, IOException
    {
        ...
        // Start of user code queryConnectorsAsHtml
        // End of user code
        ...
        if (resources!= null) {
            ...
            // Start of user code queryConnectorsAsHtml_setAttributes
            // End of user code
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/connectorscollection.jsp");
    ...
    (
         ...
         uri = "projects/{projectId}/service13/connectors/selector",
         hintWidth = "250px",
         hintHeight = "250px",
         resourceTypes = {SysmlDomainConstants.CONNECTOR_TYPE},
         usages = {}
    ...
    {
        // Start of user code ConnectorSelector_init
        // End of user code
        ...
        // Start of user code ConnectorSelector_setAttributes
        // End of user code

        if (terms != null ) {
            httpServletRequest.setAttribute("terms", terms);
            final List<Connector> resources = SysmlServerManager.ConnectorSelector(httpServletRequest, projectId, terms);
            if (resources!= null) {
                        httpServletRequest.setAttribute("resources", resources);
                        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/connectorselectorresults.jsp");
                        rd.forward(httpServletRequest, httpServletResponse);
                        return;
            }
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/org/capella/oslc/sysml/connectorselector.jsp");
            rd.forward(httpServletRequest, httpServletResponse);
            return;
        }
    }
